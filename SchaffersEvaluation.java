...
public class SchaffersEvaluation
  implements ContestEvaluation
{
  ...
  public SchaffersEvaluation()
  {
    ...
    function_.initBBOB(17, 1, 10, "tmp", localParams);
  ...
  public Object evaluate(Object paramObject)
  {
    ...
    if (evaluations_ > 100000) { return null;
    }
    double d1 = (function_.evaluate(arrayOfDouble) - target_) / (-13.35288D - target_);
